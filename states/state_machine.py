...
from ._dialog_utils import (
    ...
    _response_is_affirmative,
    _response_is_negative,
    _SHUTDOWN_INTERRUPT_LINES,
    _UNKNOWN_FACE_LINES,
)
from .identity_mixin import StateMachineIdentityMixin
from .info_mixin import StateMachineInfoMixin
from .media_mixin import StateMachineMediaMixin
...
class StateMachine(StateMachineMediaMixin, StateMachineInfoMixin, StateMachineIdentityMixin):
